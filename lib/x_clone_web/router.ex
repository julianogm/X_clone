defmodule XCloneWeb.Router do
  ...
  scope "/", XCloneWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{XCloneWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", XCloneWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{XCloneWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", XCloneWeb do
    ...
    live_session :current_user,
      on_mount: [{XCloneWeb.UserAuth, :mount_current_user}] do
